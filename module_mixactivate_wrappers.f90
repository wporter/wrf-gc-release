...
CONTAINS
	...
	real, intent(in), dimension( ims:ime, kms:kme, jms:jme ) :: &
                rho_phy, t_phy, w, z, dz8w, p_at_w, t_at_w, exch_h

	real, intent(inout), dimension( ims:ime, kms:kme, jms:jme ) :: cldfra, cldfra_old

	real, intent(in),dimension( its:ite, jts:jte, num_chem ) :: ddvel

	real, intent(in), dimension( ims:ime, kms:kme, jms:jme ) :: qv, qc, qi

    LOGICAL, intent(in) :: f_qc, f_qi

	real, intent(inout), dimension( ims:ime, kms:kme, jms:jme ) :: qndrop3d
  ...
  100 continue
      ...
      end subroutine wrfgc_mixactivate





      subroutine wrfgc_mixactivate_init(                    &
      ...
      end subroutine wrfgc_mixactivate_init
